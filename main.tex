...
\vspace{0.25 cm}
\begin{center}
\uncover<4->{\textcolor{darkblue}{This is artificial.} \\ There's a steep popularity distribution across columns, \\ but we cut it abruptly with file schemas (data tiers).}
\end{center}
\end{frame}
