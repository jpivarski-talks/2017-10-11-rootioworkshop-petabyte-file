...
\vspace{0.5 cm}
Painful decisions need to be made to keep disk size down to 1--2~kB/event, to make data access faster for 50\% of analyses while completely excluding others.
